...
const fn error_code_name(code: ErrorCode) -> &'static str {
    match code {
        ...
        ErrorCode::DelegationInvalid => "delegation invalid",
        ErrorCode::LeaseGenerationMismatch => "lease generation mismatch",
        ErrorCode::CapabilityManifestMismatch => "capability manifest mismatch",
